...
# set -g window-active-style 'fg=colour235' # fg=colour235'

# Cores padrão da janela ativa
# set -w window-active-style 'bg=default' 
# Cores padrão da janela (não-ativa)
# set -w window-style 'bg=colour249' 
#+end_src
