...
vctAdditionalKeys = [ ((vctModMask, xK_p), spawn vctLauncher)
                    , ((vctModMask, xK_z), spawn "emacsclient -c")
...
vctLayoutHook = spacing 6 $ tall ||| Grid ||| Mirror tall ||| Full
...
Config
  ...
  , additionalFonts = ["xft:FontAwesome:size=12"] -- For the icons  
  , allDesktops = True
  , position = TopW L 100
