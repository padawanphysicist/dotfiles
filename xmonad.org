...
Config
  {
  -- appearance
    font = "xft:Inconsolata for Powerline:size=20:antialias=true"
...
--  , position = Static { xpos = 0, ypos = 0, width = 1890, height = 20 }
  ...
  , template = "@UnsafeStdinReader@ | <fc=#4f94cd><fn=1></fn></fc> @multicpu@ | @memory@ • @swap@ | <fc=#4f94cd><fn=1></fn></fc> <fc=#caff70>@uptime@</fc> | <fc=#ffff00><fn=1></fn></fc> @backlight@% }{ <fc=#008b45><fn=1></fn></fc> @battery@ | <fc=#4f94cd><fn=1></fn></fc> @date@     "
  , commands =
    [
